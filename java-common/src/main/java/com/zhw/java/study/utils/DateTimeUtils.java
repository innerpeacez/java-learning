package com.zhw.java.study.utils;
...
public class DateTimeUtils {
     ...
     * @return
     */
    public static long usedMilliOfDateTime(LocalDateTime start, LocalDateTime end) {
        return getMilliByTime(end) - getMilliByTime(start);
    }
}